          ...
          <Mutation
            ...
            update={(cache, {data: {removeEmployee}}) => {
              ...
              cache.writeQuery({
                ...
                data: {employees: employees.filter((e) => e.id !== this.state.employee.id)}
              });
            }}
          >
            {(removeEmployee, {data}) => (
              <div>
                <p>
                  Are you sure you want to delete {this.state.employee.firstName} {this.state.employee.lastName}?
                </p>
