                  ...
                  'undefined' != typeof this.options.optimizations &&
                    ...
                    !(function () {
                      ...
                      if (
                        ...
                        (o.right =
                          A.body.scrollWidth - o.left - n.width + r.right),
                        (o.bottom =
                          A.body.scrollHeight - o.top - n.height + r.bottom),
            ...
            'together' === h &&
              (i < b[0] && 'left' === v.left
                ? 'right' === y.left
                  ...
                  : 'left' === y.left &&
                    ((i += u), (v.left = 'right'), (i -= f), (y.left = 'right'))
                : i + f > b[2] && 'right' === v.left
                ? 'left' === y.left
                  ? ((i -= u), (v.left = 'left'), (i -= f), (y.left = 'right'))
                  : 'right' === y.left &&
                    ((i -= u), (v.left = 'left'), (i += f), (y.left = 'left'))
                : 'center' === v.left &&
                  (i + f > b[2] && 'left' === y.left
                    ? ((i -= f), (y.left = 'right'))
                    : i < b[0] &&
