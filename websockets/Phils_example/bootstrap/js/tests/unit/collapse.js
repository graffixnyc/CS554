$(function () {
  ...
  QUnit.test(
    'should reset style to auto after finishing closing collapse',
    function (assert) {
      assert.expect(1);
      var done = assert.async();
  ...
  QUnit.test(
    ...
    function (assert) {
      ...
      var $target = $(
        '<a role="button" data-toggle="collapse" class="collapsed" href="#test1"/>'
  ...
  QUnit.test(
    ...
    function (assert) {
      ...
      var $target = $(
        '<a role="button" data-toggle="collapse" href="#test1"/>'
      ).appendTo('#qunit-fixture');
  ...
  QUnit.test(
    ...
    function (assert) {
      ...
      var $target1 = $(
        '<a role="button" data-toggle="collapse" href="#body1" data-parent="#accordion"/>'
      ).appendTo($groups.eq(0));

      $('<div id="body1" class="in"/>').appendTo($groups.eq(0));

      var $target2 = $(
        '<a class="collapsed" data-toggle="collapse" role="button" href="#body2" data-parent="#accordion"/>'
      ).appendTo($groups.eq(1));

      $('<div id="body2"/>').appendTo($groups.eq(1));

      var $target3 = $(
        '<a class="collapsed" data-toggle="collapse" role="button" href="#body3" data-parent="#accordion"/>'
  ...
  QUnit.test(
    ...
    function (assert) {
      ...
      var $target = $(
        '<a role="button" data-toggle="collapse" class="collapsed" href="#test1" aria-expanded="false"/>'
      ).appendTo('#qunit-fixture');
  ...
  QUnit.test(
    ...
    function (assert) {
      ...
      var $target = $(
        '<a role="button" data-toggle="collapse" href="#test1" aria-expanded="true"/>'
      ).appendTo('#qunit-fixture');
  ...
  QUnit.test(
    ...
    function (assert) {
      ...
      $('<div id="body1" aria-expanded="true" class="in"/>').appendTo(
        $groups.eq(0)
      );

      var $target2 = $(
        '<a role="button" data-toggle="collapse" href="#body2" data-parent="#accordion" class="collapsed" />'
      ).appendTo($groups.eq(1));
  ...
  QUnit.test(
    ...
    function (assert) {
      ...
      var $target2 = $(
        '<a role="button" data-toggle="collapse" href="#body2" data-parent="#accordion"/>'
      ).appendTo($groups.eq(1));
      var $body2 = $('<div id="body2" class="collapse"/>').appendTo(
        $groups.eq(1)
      );
