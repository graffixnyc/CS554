$(function () {
  ...
  QUnit.test('should reset when slide is prevented', function (assert) {
    ...
    $carousel
      .one('slide.bs.carousel', function (e) {
        ...
        setTimeout(function () {
          assert.ok(
            $carousel.find('.carousel-item:eq(0)').is('.active'),
            'first item still active'
          );
          assert.ok(
            $carousel.find('.carousel-indicators li:eq(0)').is('.active'),
      ...
      .one('slid.bs.carousel', function () {
        setTimeout(function () {
          ...
          assert.ok(
            $carousel.find('.carousel-item:eq(1)').is('.active'),
            'second item active'
          );
          assert.ok(
            $carousel.find('.carousel-indicators li:eq(1)').is('.active'),
  ...
  QUnit.test('should fire slide event with relatedTarget', function (assert) {
    ...
    $(template)
      .on('slide.bs.carousel', function (e) {
        ...
        assert.ok(
          $(e.relatedTarget).hasClass('carousel-item'),
  ...
  QUnit.test('should set interval from data attribute', function (assert) {
    ...
    $('[data-slide]').first().trigger('click');
    assert.strictEqual(
      $carousel.data('bs.carousel')._config.interval,
      1814,
  ...
  QUnit.test(
    ...
    function (assert) {
      ...
      $.each(['mouseover', 'mouseout'], function (i, type) {
        assert.strictEqual(
          type in $._data($template[0], 'events'),
          !isMobile,
          'does' + (isMobile ? ' not' : '') + ' listen for ' + type + ' events'
        );
      });
    }
  );
  ...
  QUnit.test(
    ...
    function (assert) {
      ...
      $carousel
        .on('slid.bs.carousel', function () {
          assert.strictEqual(
            $carousel.find('.carousel-item.active').attr('id'),
            'three',
