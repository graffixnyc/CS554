            ...
            (this.validate = function (parameters) {
              ...
              return (
                requiredOptions.forEach(function (requiredOptionName) {
                  void 0 === parameters[requiredOptionName] &&
    ...
    4: [
      function (require, module, exports) {
        ...
        function isObject(obj) {
          return (
            !!obj && '[object Object]' === Object.prototype.toString.call(obj)
          );
        }
        function isArray(obj) {
          return (
            !!obj && '[object Array]' === Object.prototype.toString.call(obj)
          );
        }
        ...
        function findMatches(data, crit, strategy, opt) {
          for (
            var matches = [], i = 0;
            i < data.length && matches.length < opt.limit;
            i++
          ) {
        ...
        function LiteralSearchStrategy() {
          this.matches = function (string, crit) {
            return (
              ...
              ((string = string.trim()),
              string.toLowerCase().indexOf(crit.toLowerCase()) >= 0)
            );
          };
        }
      ...
      function (require, module, exports) {
        ...
        function setOptions(_options) {
          (options.pattern = _options.pattern || options.pattern),
            ...
            'function' == typeof _options.middleware &&
              (options.middleware = _options.middleware);
        }
        function compile(data) {
          return options.template.replace(options.pattern, function (
            match,
            prop
          ) {
        ...
        !(function (window, document, undefined) {
          ...
          (window.SimpleJekyllSearch = function (_options) {
            ...
            'function' == typeof window.SimpleJekyllSearchInit &&
              window.SimpleJekyllSearchInit.call(
                this,
    ...
    9: [
      function (require, module, exports) {
        ...
        function isJSON(json) {
          try {
            return !!(
              json instanceof Object && JSON.parse(JSON.stringify(json))
            );
          } catch (e) {
            return !1;
          }
