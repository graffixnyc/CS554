    ...
    (this.options = A || {}),
        ...
        for (
          ...
          if (this.hasAnchorJSLink(i[r])) w.push(r);
            ...
            (d = c.replace(/-/g, ' ')),
              ...
              (f.className = 'anchorjs-link ' + this.options.class),
              (f.href = '#' + c),
              f.setAttribute('aria-label', 'Anchor link for: ' + d),
              f.setAttribute('data-anchorjs-icon', this.options.icon),
              'always' === p && (f.style.opacity = '1'),
              '' === this.options.icon &&
                ((f.style.font = '1em/1 anchorjs-icons'),
                'left' === this.options.placement &&
                  (f.style.lineHeight = 'inherit')),
              'left' === this.options.placement
                ? ((f.style.position = 'absolute'),
                  (f.style.marginLeft = '-1em'),
                  (f.style.paddingRight = '0.5em'),
                  i[r].insertBefore(f, i[r].firstChild))
                : ((f.style.paddingLeft = '0.375em'), i[r].appendChild(f));
          }
      ...
      (this.remove = function (A) {
        for (var e, n, i = t(A), o = 0; o < i.length; o++)
          (n = i[o].querySelector('.anchorjs-link')),
            n &&
              ((e = this.elements.indexOf(i[o])),
              -1 !== e && this.elements.splice(e, 1),
              i[o].removeChild(n));
        return this;
      }),
